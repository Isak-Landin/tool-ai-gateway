...
_Idea development tracking for the bootstrap module (BS1, BS2, and their verification and caller surfaces). BS1 and BS2 are finalized modules in code. Their surrounding callers and responders in other layers are not yet established._
